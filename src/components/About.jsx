        ...
        <div className="d-flex justify-content-evenly align-items-center mt-5 row">
            ...
            <div className="abcontent col-lg-7">
                    ...
                    <div className="cont2 d-flex  justify-content-evenly align-items-center mt-3 ">
                        <div className="bg-light rounded medal">
                            <img src={img3} style={{width:'100%'}} alt="" />
                            
                        </div><span className="text-light ms-2" style={{width:'99%'}}><b>Proficient Full Stack Developer:</b> Experienced in web development and UI design, capable of creating high-quality wireframes, demos, and prototypes using HTML, CSS, JavaScript, Bootstrap, Material-UI, ReactJS, and Redux.</span>
                    </div>
                    ...
                    <div className="bg-light rounded medal">
                        ...
                        <span className="text-light ms-2" style={{width:'95%'}}><b>Advanced Mobile Platform Understanding:</b> Strong grasp of mobile platforms, ensuring seamless and responsive designs that enhance user experience across devices.</span>
                    </div>
                    <div className="cont2 d-flex  justify-content-evenly align-items-center mt-4">
                        <div className="bg-light rounded medal" >
                            <img src={img3} style={{width:'100%'}} alt="" />
                            
                        </div><span className="text-light ms-2 " style={{width:'95%'}}><b>Detail-Oriented and Efficient:</b> Highly organized with a focus on detail, consistently delivering projects with precision and efficiency, as demonstrated through various personal and professional projects.</span>
                    </div>
